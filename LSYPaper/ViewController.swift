...
let cellGap:CGFloat = 2
 let tinyCellReuseIdentifier = "TinyNewsDetailCell"
 let fullScreenCellReuseIdentifier = "BigNewsDetailCell"

 let fullScreenGap:CGFloat = cellGap * SCREEN_WIDTH / normalCellWidth

 let tinyCollectFrame = CGRect(x: -SCREEN_WIDTH * 2, y: POSTER_HEIGHT, width: SCREEN_WIDTH * 5, height: CELL_NORMAL_HEIGHT)
 let fullScreenCollectFrame = CGRect(x: -SCREEN_WIDTH * 2, y: 0, width: SCREEN_WIDTH * 5, height: SCREEN_HEIGHT)
 let fullScreenPageEnableCollectFrame = CGRect(x: -fullScreenGap / 2, y: 0, width: SCREEN_WIDTH + fullScreenGap, height: SCREEN_HEIGHT)

 let hideStartRatio:CGFloat = 4 / 7
 let hideOverRatio:CGFloat = 0.85

 let minCellRatio:CGFloat = 3 / 4
 let maxCellRatio:CGFloat = 1.5
 let minScale:CGFloat = 0.95
 let normalCellWidth:CGFloat = CELL_NORMAL_HEIGHT * SCREEN_WIDTH / SCREEN_HEIGHT

class ViewController: UIViewController {
    
     let tinyCollectionView = UICollectionView(frame: tinyCollectFrame, collectionViewLayout: UICollectionViewFlowLayout())
     let fullScreenCollectionView = UICollectionView(frame: fullScreenCollectFrame, collectionViewLayout: UICollectionViewFlowLayout())

     var pageControl:LSYPageControl = LSYPageControl()
     ...
     var fullScreenCollectionViewLayout:UICollectionViewFlowLayout {
        let layout = UICollectionViewFlowLayout()
        layout.scrollDirection = UICollectionViewScrollDirection.horizontal
     ...
     var tinyPanCollect:UIPanGestureRecognizer = UIPanGestureRecognizer()
     var tinyTapCollect:UITapGestureRecognizer = UITapGestureRecognizer()
     var fullScreenPanCollect:UIPanGestureRecognizer = UIPanGestureRecognizer()
    
     var isPanVertical:Bool = false
     var isFromFullScreen:Bool = false
     var hasReachNormalHeightFromFullScreen:Bool = false
     var reachNormalLocationYFromFullScreen:CGFloat = 0.0
     var reachNormalTransitionYFromFullScreen:CGFloat = 0.0
     var locationInView:CGPoint = CGPoint.zero
     var translationInView:CGPoint = CGPoint.zero
     var currentContentOffset:CGPoint = CGPoint.zero
     var locationRatio:CGFloat = 0
    ...
    @objc func handleCollectTapGesture(_ recognizer:UIPanGestureRecognizer) {
     ...
     @objc func handleCollectPanGesture(_ recognizer:UIPanGestureRecognizer) {
    ...
    /* panOffY * panOffY = (1- minRatio) * (1- minRatio) * normalHeight * normalHeight * transitionY/ (normalHeight - locationY) */
     ...
     func reachNormalHeightSetting(_ recognizer:UIPanGestureRecognizer) {
